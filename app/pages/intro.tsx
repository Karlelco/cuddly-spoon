...
function Intro() {
  return (
    <section className="flex min-h-screen flex-col items-center justify-between px-6 shadow-blue-400 md:px-24 py-12">
      ...
      />
      <div className="flex flex-col md:flex-row  mt-10 w-full h-[10rem] justify-around items-center  md:mr-20 gap-20 ">
        <div>
